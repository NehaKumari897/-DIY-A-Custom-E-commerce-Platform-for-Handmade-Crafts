...
import { Check, Home, Package, ShoppingBasketIcon } from "lucide-react";
    ...
    <div className="py-5 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center mx-4">
      ...
      >
        <motion.div
          ...
          className="w-20 h-20 bg-shadow-pink-400 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg"
        >
